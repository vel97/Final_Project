...
# cust['marital_divorced'] = cust['marital_divorced'].astype(str)
# cust['marital_married'] = cust['marital_married'].astype(str)
# cust['marital_single'] = cust['marital_single'].astype(str)
